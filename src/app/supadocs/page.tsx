        ...
        <div className="w-full mx-auto px-4 py-4 h-full flex flex-col">
          ...
          {selectedFile ? (
            ...
            <div className="flex lg:flex-row flex-col-reverse gap-3 flex-1 overflow-hidden h-full relative">
              ...
              `}>
                <div className="bg-white dark:bg-[#0F0F0F] overflow-hidden flex flex-col h-full lg:rounded-lg lg:border lg:border-gray-200 lg:dark:border-[#151515] rounded-none border-0">
