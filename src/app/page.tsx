...
export default function Home() {
  return (
    <div className="relative w-screen h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-2 sm:inset-4 flex items-right justify-center">
      ...
      <div className="absolute left-4 sm:left-8 top-1/2 transform -translate-y-1/2 z-10 px-2 sm:px-0">
        <div className="max-w-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/login"
              className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-semibold text-lg transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 transform hover:scale-105 text-center"
            >
            ...
            <Link
              href="#demo"
              className="px-8 py-4 border-2 border-gray-600 rounded-full text-white font-semibold text-lg hover:border-white hover:bg-white hover:text-black transition-all duration-300 text-center"
            >
              Watch Demo
            </Link>
          </div>

          <div className="hidden mt-8 md:flex flex-wrap gap-6 text-sm text-gray-400">
