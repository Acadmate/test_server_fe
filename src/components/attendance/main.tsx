      ...
      {data && data.length > 0 ? (
        <div className="flex flex-col gap-2 border border-gray-300 dark:border-gray-700 rounded-2xl">
          {data.map((item, index) => (
            <div
              key={index}
              className={`flex flex-col md:flex-row rounded-2xl bg-gray-100 ${
            ...
            >
              ...
              <div
                className={`gap-[3px] w-full text-xs text-black-500 dark:text-yellow-500 ${
                  predictedButton == 1 ? "flex flex-row items-center" : "hidden"
                }`}
              >
                <span>
                  <FaExclamationCircle />
