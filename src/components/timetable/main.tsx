    ...
    <>
      {check !== 0 ? (
        <div className="h-[175vh] lg:h-[90vh]">
          ...
          <div className="lg:hidden fixed flex flex-row items-center justify-between gap-2 p-2 bottom-5 left-1/2 transform -translate-x-1/2 bg-gray-500/70 dark:bg-black/70 backdrop-blur-sm text-white font-bold rounded-full shadow-lg">
            <div
