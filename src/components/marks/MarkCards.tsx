            ...
            return (
              ...
              >
                ...
                {Object.keys(mark["Test Performance"]).length > 0 ? (
                  <div className="grid grid-cols-3 py-1 bg-[#F3F4F6] text-base my-1 text-black dark:bg-[#171B26] dark:text-white dark:border-500 border-[1px] rounded-lg border-gray-400 font-semibold text-center">
                    <div>Component</div>
                    <div>Max</div>
                    <div>Scored</div>
                  </div>
